describe("nmbr", function() {
    var nmbr;
    nmbr = require('nmbr')
    expect = require('expect.js')
    it("should be a function", function() {
            expect(nmbr).to.be.a('function')
    })
    it("should construct a new number object, based on input", function() {
        ...
        if (typeof one !== 'object') {
            ...
            throw new Error('unexpected value of construct: ' + one.value)
        } else {
            return true
        }
    })
    return describe('number object', function() {
        ...
        it ('should init', function(){
            ...
            ten = nmbr(10)
            thirty = nmbr(30)
            x = nmbr(nmbr(3), nmbr(10))
            y = nmbr(nmbr(3), nmbr(14))
            third = nmbr(one, three)
