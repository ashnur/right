void function(root){
    ...
    var Int, Nat, Rat, ccc, gcd
        , hashify, isInt, isNat
        , number, numbers, op, ZERO, ONE;
    ...
    function isNat (input) { return isInt(input) && parseInt(input, 10) > 0 }
    ...
    function hashify (input, input2) {
        ...
        } else if (typeof input !== 'object' && !Array.isArray(input) && isInt(parseInt(input, 10))) {
